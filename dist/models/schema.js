...
const password = _bcrypt2.default.hashSync("111111", _bcrypt2.default.genSaltSync(7));
...
VALUES('admin@mail.com','${password}','admin');
`;

const addAttendant = `INSERT INTO users(email, password)
VALUES('user@mail.com','${password}');
`;

const tables = `${addAdmin} ${addAttendant}`;
